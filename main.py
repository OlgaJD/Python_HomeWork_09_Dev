...
class TicTacToeBoard:
    ...
    def make_move(self, row, col):
        if row > 3 or col > 3:
            return "Значения столбцов и строк могут принимать значения от 1 до 3"
        elif self.end_of_game and not self.first_move:
...
print(board.make_move(4, 1))  ## Проверка значений row и col
print(*board.get_field(), sep="\n")
